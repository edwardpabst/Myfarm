...
describe "podetails/new.html.erb" do
  before(:each) do
    assign(:podetail, stub_model(Podetail,
      :po_id => 1,
      :user_id => 1,
      :supply_id => 1,
      :storage_id => 1,
  ...
  it "renders new podetail form" do
    render

    # Run the generator again with the --webrat-matchers flag if you want to use webrat matchers
    assert_select "form", :action => podetails_path, :method => "post" do
