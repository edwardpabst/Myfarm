...
describe "retailcrops/new.html.erb" do
  before(:each) do
    assign(:retailcrop, stub_model(Retailcrop,
      :cropplan_id => 1,
      :user_id => 1,
      :farm_id => 1,
      :status => "MyString",
  ...
  it "renders new retailcrop form" do
    render

    # Run the generator again with the --webrat-matchers flag if you want to use webrat matchers
    assert_select "form", :action => retailcrops_path, :method => "post" do
