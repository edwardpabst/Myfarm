...
describe "retailorders/new.html.erb" do
  before(:each) do
    assign(:retailorder, stub_model(Retailorder,
      :source_user_id => 1,
      :order_user_id => 1,
  ...
  it "renders new retailorder form" do
    render

    # Run the generator again with the --webrat-matchers flag if you want to use webrat matchers
    assert_select "form", :action => retailorders_path, :method => "post" do
